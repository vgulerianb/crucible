      ...
      {action && action !== "chat" ? (
        <>
          ...
          <button
            ...
            type="button"
            className="w-full text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 h-[40px] flex justify-center items-center font-medium rounded-lg text-sm text-center mr-2 mb-2"
          >
